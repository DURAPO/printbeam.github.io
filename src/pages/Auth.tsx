...
import { ArrowRight, Loader2, Mail, UserX, Printer } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background font-mono">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <Card className="min-w-[340px] max-w-[380px] w-full border-border shadow-sm font-mono">
          {step === "signIn" ? (
            <>
              <CardHeader className="text-center">
                <CardTitle className="text-base">
                  <span className="text-success">⟩</span> sign in
                </CardTitle>
            ...
            <>
              <CardHeader className="text-center">
                <CardTitle className="text-base">
                  <span className="text-success">⟩</span> verify code
                </CardTitle>
                <CardDescription className="text-xs">
              ...
              <form onSubmit={handleOtpSubmit}>
                <CardContent className="pb-4">
                  ...
                  <p className="text-xs text-muted-foreground text-center mt-4">
                    ...
                    <Button
                      variant="link"
                      className="p-0 h-auto text-success text-xs"
